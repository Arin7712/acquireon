    ...
    <div className="flex justify-center w-full fixed top-0 z-50 pt-4">
      ...
      >
        ...
        >
          ...
          <Bell className="bg-indigo-500 text-neutral-100 rounded-full p-2 size-9 hover:cursor-pointer hover:border-[1px] hover:bg-neutral-800 hover:text-neutral-200 transition-colors" />
        </motion.div>
