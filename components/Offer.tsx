...
const Offer = () => {
  return (
    <div className="flex flex-col items-center h-auto md:px-[10rem] px-6 py-[6rem] gap-6">
      ...
      <div className="flex md:flex-col flex-col gap-10 pt-6">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="bg-neutral-900 rounded-md p-6 py-10 md:w-auto w-full md:max-w-3xl min-w-[50%] text-white flex md:flex-row flex-col justify-between"
        >
